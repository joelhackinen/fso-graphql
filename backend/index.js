...
const resolvers = {
  Query: {
    ...
    allBooks: (root, args) => {
      const authorFiltered = args.author ? books.filter(b => b.author === args.author) : books
      return args.genre ? authorFiltered.filter(b => b.genres.includes(args.genre)) : authorFiltered
    },
